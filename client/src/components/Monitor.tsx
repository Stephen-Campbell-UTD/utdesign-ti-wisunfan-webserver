...
function LogIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M9 9H15" stroke="white" strokeWidth="2" stroke-linecap="round" />
      <path d="M9 13H15" stroke="white" strokeWidth="2" stroke-linecap="round" />
      <path d="M9 17H13" stroke="white" strokeWidth="2" stroke-linecap="round" />
    </svg>
  );
}
